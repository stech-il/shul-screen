...
export function normalizeConfig(config: SynagogueConfig): SynagogueConfig {
  ...
  return {
    ...
    showRoshChodesh: config.showRoshChodesh ?? true,
    showShabbatMevarchim: config.showShabbatMevarchim ?? true,
    showMolad: config.showMolad ?? true,
    showSpecialShabbat: config.showSpecialShabbat ?? true,
